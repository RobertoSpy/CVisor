  ...
  return (
    <div className="max-w-3xl mx-auto mt-12 bg-gradient-to-br from-white via-blue-50 to-violet-100 p-0 rounded-3xl shadow-2xl overflow-hidden">
      ...
      <div className="relative">
        ...
        <Link href="/organization/opportunities" className="absolute top-5 left-5 bg-white/80 backdrop-blur px-4 py-2 text-primary rounded-full shadow hover:bg-white transition text-sm font-semibold border border-primary">
