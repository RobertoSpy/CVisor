...
import { FaMapMarkerAlt, FaCalendarAlt, FaUsers, FaMoneyBillWave, FaListUl, FaStar, FaPlay, FaClock, FaCheckCircle, FaArrowLeft, FaEdit, FaTrash } from "react-icons/fa";
...
export default function OrganizationOpportunityDetailsPage() {
  ...
  useEffect(() => {
    if (!id) return;
    ApiClient.get(`/api/opportunities/${id}`)
      .then(data => {
        setOpp(data);
        setLoading(false);
      })
  ...
  if (!opp) return (
    <div className="flex flex-col items-center justify-center min-h-[60vh] text-center">
      ...
      <Link href="/organization/opportunities" className="text-blue-600 hover:underline">
