...
import { FaMapMarkerAlt, FaCalendarAlt, FaUsers, FaMoneyBillWave, FaListUl, FaStar } from "react-icons/fa";
...
export default function ExploreDetailPage() {
  ...
  useEffect(() => {
    fetch(`/api/organizations/opportunities/explore/${id}`, {
      credentials: "include"
    })
      .then(res => res.json())
      .then(data => {
  ...
  return (
    <div className="max-w-3xl mx-auto mt-12 bg-gradient-to-br from-white via-blue-50 to-violet-100 p-0 rounded-3xl shadow-2xl overflow-hidden">
      ...
      <div className="relative">
        ...
        <Link href="/organization/explore" className="absolute top-5 left-5 bg-white/80 backdrop-blur px-4 py-2 text-primary rounded-full shadow hover:bg-white transition text-sm font-semibold border border-primary">
      ...
      {opp.organization_name && (
        <div className="px-8 pt-6 text-xl font-bold text-blue-600">
          Organizat de: {opp.organization_name}
        </div>
      )}
